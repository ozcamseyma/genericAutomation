...
2a) Hangi yöntem daha kullanışlı?
    Genellikle Runnable interfaceini implement ederek oluşturmak daha çok tercih edilir.
    Çünkü Javada sadece bir class extend edebiliriz bu hakkımızı Thread ile harcamak istemeyiz.
